...
# Windows server usually doesn't have Az cmdlets
Install-Module -Name Az
Connect-AzAccount -Tenant e3f1b00d-ea6f-4c5a-9d70-f2f5945431e9 
Select-AzSubscription -Subscription firstsub
$storageSync = Get-AzStorageSyncService -ResourceGroupName learn-file-sync-rg
# Register the sever with file sync using admin Azure account
