...
$VaultName = "restoreMarsVault" #fetch automatically
$Subscription = "firstsub" #fetch automatically
$ResourceGroup = "restore-vms" #fetch automatically
$SubscriptionId = "e7dc935a-7e69-4b70-90e9-4a4eb71d7ca6" #fetch automatically
